...
[System.Serializable]
public class PoolQueue<T> : Queue<T>, IPool<T> where T : MonoBehaviour
{
    ...
    public T GetObject()
    {
        ...
        return TryDequeue(out var value) ? value : Instantiate.Invoke(original);//要素があれば ? : オブジェクト : 新規のオブジェクトを返す
    }
}
