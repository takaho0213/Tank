...
namespace Tank
{
    ...
    public class AudioScript : MonoBehaviour
    {
        ...
        [field: SerializeField] public AudioInfo<StageClip> StageAudio { get; private set; }

        /// <summary>タンクオーディオ</summary>
        [field: SerializeField] public ClipInfo<TankClip> TankAudio { get; private set; }

        /// <summary>弾オーディオ</summary>
        [field: SerializeField] public ClipInfo<BulletClip> BulletAudio { get; private set; }
    }
