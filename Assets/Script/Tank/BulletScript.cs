    ...
    public class BulletScript : MonoBehaviour
    {
        ...
        private void OnTriggerEnter2D(Collider2D hit)
        {
            ...
            if (Info.IsReflection(hit, ReflectionCount))                                             //反射できるなら
            {
                ...
                AudioScript.I.BulletAudio.Clips[BulletClip.Reflection].PlayOneShot(ReflectionSource);//反射SEを再生
        ...
        private IEnumerator ExplosionEffect()
        {
            ...
            var c = AudioScript.I.BulletAudio.Clips[BulletClip.Explosion];//爆発SEクリップ
